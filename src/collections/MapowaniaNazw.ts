...
export const MapowaniaNazw: CollectionConfig = {
  ...
  fields: [
    ...
    },
    {
      ...
      admin: {
        description:
          "Nazwa używana w szkole (powinna odpowiadać nazwie w bazie)",
      },
    },
    {
      name: "typ",
    ...
    },
    {
      ...
      label: "Przedmiot",
      admin: {
        condition: (data: any) => data.typ === "przedmiot",
        description:
          "Przedmiot w bazie (opcjonalnie, jeśli nazwa_szkola nie wystarczy)",
      },
    },
    {
      name: "typ_szkoly",
      ...
      label: "Typ szkoły",
      admin: {
        condition: (data: any) => data.typ === "typ_szkoly",
